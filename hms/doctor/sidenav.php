...
<html>
  ...
  <body>
    <!--Sidenav-->
    <div class="list-group list-group-flush bg-info" style="height: 90vh;">
      ...
      <a href="#" class="list-group-item list-group-item-action bg-info text-center text-white">Appointments</a>
    </div>
  </body>
</html>
