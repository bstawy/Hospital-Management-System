      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-10">
            <div class="col-md-12">
              <div class="row my-3">
                <h5 class="text-center">Update patient's credentials</h5>
                <br><br>
                <div class="col-md-6">
                    ...
                    <table class='table table-bordered'>
                      ...
                      <tr>
                        ...
                        <td><?php 
                          $dep_id = $row['dep_id'];
                          if ($dep_id == 0) {
                            $dep_name = "Not department assigned";
                          }else {
                ...
                <div class="col-md-3">
                  <?php 
                    if(isset($_POST['change'])){
                      ...
                      if(empty($uname)){
                        ...
                        $query = "UPDATE patient SET username='$uname' WHERE username='$pat'";
                        $res = mysqli_query($connect,$query);
                        if($res) {
                  ...
                  <?php 
                    if(isset($_POST['update_pass'])){
                      ...
                      $old = mysqli_query($connect,"SELECT * FROM patient WHERE username='$pat'");
                      ...
                      if(count($error) == 0) {
                        $query = "UPDATE patient SET password='$new_pass' WHERE username = '$pat'";
